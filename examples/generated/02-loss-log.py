...
# tool version 0.6.0, spec sha256:1c61c5aa6f8eaf92
...
SPEC_HASH = "1c61c5aa6f8eaf92"
SPEC_JSON = "{\"title\":\"Training loss\",\"group\":\"model\",\"series_order\":[\"baseline\",\"+augment\",\"+distill\",\"ours\"],\"legend\":{\"show\":true,\"position\":\"upper_right\",\"style\":\"box\"},\"output\":{\"interactive\":false,\"latex\":false,\"size\":\"single_column\",\"formats\":[\"png\",\"svg\",\"pdf\"],\"dpi\":600,\"stem\":\"02-loss-log\"},\"style\":{\"preset\":\"paper\",\"grid\":false,\"despine\":true,\"venue\":\"none\"},\"data\":{\"path\":\"data/training.csv\",\"format\":\"csv\",\"columns\":[\"model\",\"seed\",\"epoch\",\"accuracy\",\"loss\"]},\"x\":{\"field\":\"epoch\",\"label\":\"Training epoch\",\"scale\":\"linear\",\"percent\":false,\"temporal\":false},\"y\":{\"field\":\"loss\",\"label\":\"Training loss\",\"scale\":\"log\",\"percent\":false,\"temporal\":false},\"kind\":\"line\",\"marker\":false,\"sort_x\":true,\"aggregation\":\"median\"}"
X_AXIS_LABEL = "Training epoch"
Y_AXIS_LABEL = "Training loss"
FIGURE_TITLE = "Training loss"
ENCODING_SENTENCE = "Line chart of Training loss against Training epoch. One series per model, being baseline, +augment, +distill, ours. The vertical axis is logarithmic."
AUTHOR_CONTEXT = None
CAPTION = None
...
def main():
    ...
    with plt.rc_context(RC_PARAMS):
        ...
        if len(blocks) > 1:
            ...
            flat[0].set_title("Training loss")
        fig.tight_layout()
        check(fig)

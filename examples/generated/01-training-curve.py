...
# tool version 0.6.0, spec sha256:4f126780e66945c3
...
def main():
    ...
    with plt.rc_context(RC_PARAMS):
        ...
        if len(blocks) > 1:
            fig.suptitle("Test accuracy over training")
        else:
            flat[0].set_title("Test accuracy over training")

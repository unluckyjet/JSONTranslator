...
# tool version 0.6.0, spec sha256:bfec33b385a0e501
...
PALETTE_LOCK = None
LOCKED = None
STEM = "13-direct-labels"
FORMATS = ["png", "svg", "pdf"]
DPI = 600
TOOL = "GraphUnslopify 0.6.0"
SPEC_HASH = "bfec33b385a0e501"
SPEC_JSON = "{\"group\":\"model\",\"series_order\":[\"baseline\",\"+augment\",\"+distill\",\"ours\"],\"emphasis\":{\"series\":\"ours\"},\"legend\":{\"show\":true,\"position\":\"best\",\"style\":\"direct\"},\"output\":{\"interactive\":false,\"latex\":false,\"size\":\"double_column\",\"formats\":[\"png\",\"svg\",\"pdf\"],\"dpi\":600,\"stem\":\"13-direct-labels\"},\"style\":{\"preset\":\"paper\",\"grid\":false,\"despine\":true,\"venue\":\"none\"},\"data\":{\"path\":\"data/training.csv\",\"format\":\"csv\",\"columns\":[\"model\",\"seed\",\"epoch\",\"accuracy\",\"loss\"]},\"x\":{\"field\":\"epoch\",\"label\":\"Training epoch\",\"scale\":\"linear\",\"percent\":false,\"temporal\":false},\"y\":{\"field\":\"accuracy\",\"label\":\"Test accuracy\",\"unit\":\"%\",\"scale\":\"linear\",\"percent\":false,\"temporal\":false},\"kind\":\"line\",\"marker\":false,\"sort_x\":true,\"aggregation\":\"mean\"}"
...
def add_legend(fig, ax, frame):
    label_series_directly(ax, frame)

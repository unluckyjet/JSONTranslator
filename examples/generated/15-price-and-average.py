...
# tool version 0.6.0, spec sha256:7950df04c3b07a1a
...
LOCKED = None
ANNOTATIONS = [
    {"at": "min", "series": None, "text": "the average turns after the price does"},
]
STEM = "15-price-and-average"
FORMATS = ["png", "svg", "pdf"]
DPI = 600
TOOL = "GraphUnslopify 0.6.0"
SPEC_HASH = "7950df04c3b07a1a"
SPEC_JSON = "{\"title\":\"The average follows the price, it does not predict it\",\"annotate\":[{\"at\":\"min\",\"text\":\"the average turns after the price does\"}],\"legend\":{\"show\":false,\"position\":\"best\",\"style\":\"box\"},\"output\":{\"interactive\":false,\"latex\":false,\"size\":\"double_column\",\"formats\":[\"png\",\"svg\",\"pdf\"],\"dpi\":600,\"stem\":\"15-price-and-average\"},\"style\":{\"preset\":\"paper\",\"grid\":false,\"despine\":true,\"venue\":\"none\"},\"data\":{\"path\":\"data/prices.csv\",\"format\":\"csv\",\"columns\":[\"date\",\"close\",\"volume\"]},\"alt_text\":\"Simulated data. No real company is depicted.\",\"caption\":\"Simulated daily closing price for one trading year, with a 20-day rolling average.\",\"x\":{\"field\":\"date\",\"label\":\"Date\",\"scale\":\"linear\",\"percent\":false,\"temporal\":true},\"y\":{\"field\":\"close\",\"label\":\"Closing price\",\"unit\":\"$\",\"scale\":\"linear\",\"limits\":[37,61],\"percent\":false,\"temporal\":false},\"kind\":\"line\",\"marker\":false,\"sort_x\":true,\"aggregation\":\"mean\",\"smooth\":{\"kind\":\"rolling\",\"window\":20,\"show_raw\":true}}"
X_AXIS_LABEL = "Date"

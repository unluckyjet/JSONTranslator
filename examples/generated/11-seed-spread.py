...
# tool version 0.6.0, spec sha256:18e44aa49b16ac64
...
SPEC_HASH = "18e44aa49b16ac64"
SPEC_JSON = "{\"title\":\"Run-to-run variance\",\"filter\":[{\"field\":\"epoch\",\"op\":\"gte\",\"value\":20}],\"legend\":{\"show\":false,\"position\":\"best\",\"style\":\"box\"},\"output\":{\"interactive\":false,\"latex\":false,\"size\":\"single_column\",\"formats\":[\"png\",\"svg\",\"pdf\"],\"dpi\":600,\"stem\":\"11-seed-spread\"},\"style\":{\"preset\":\"paper\",\"grid\":false,\"despine\":true,\"venue\":\"none\"},\"data\":{\"path\":\"data/training.csv\",\"format\":\"csv\",\"columns\":[\"model\",\"seed\",\"epoch\",\"accuracy\",\"loss\"]},\"x\":{\"field\":\"model\",\"label\":\"Model\",\"scale\":\"linear\",\"percent\":false,\"temporal\":false},\"y\":{\"field\":\"accuracy\",\"label\":\"Accuracy across epochs\",\"unit\":\"%\",\"scale\":\"linear\",\"percent\":false,\"temporal\":false},\"kind\":\"box\",\"show_points\":false,\"notch\":false,\"sort\":{\"by\":\"value\",\"direction\":\"desc\"}}"
X_AXIS_LABEL = "Model"
Y_AXIS_LABEL = "Accuracy across epochs (%)"
FIGURE_TITLE = "Run-to-run variance"
ENCODING_SENTENCE = "Box plot of Accuracy across epochs in % against Model."
AUTHOR_CONTEXT = None
CAPTION = None
X_LABEL_PLAIN = "model"
CLAIMS = []

...
# tool version 0.6.0, spec sha256:28644fb33abd5979
...
SPEC_HASH = "28644fb33abd5979"
SPEC_JSON = "{\"title\":\"Accuracy across benchmarks\",\"group\":\"model\",\"series_order\":[\"baseline\",\"+augment\",\"+distill\",\"ours\"],\"emphasis\":{\"series\":\"ours\"},\"legend\":{\"show\":true,\"position\":\"outside_bottom\",\"style\":\"box\"},\"output\":{\"interactive\":false,\"latex\":false,\"size\":\"single_column\",\"formats\":[\"png\",\"svg\",\"pdf\"],\"dpi\":600,\"stem\":\"04-accuracy-by-dataset\"},\"style\":{\"preset\":\"paper\",\"grid\":false,\"despine\":true,\"venue\":\"none\"},\"data\":{\"path\":\"data/benchmarks.csv\",\"format\":\"csv\",\"columns\":[\"model\",\"dataset\",\"accuracy\",\"latency_ms\",\"params_m\"]},\"x\":{\"field\":\"dataset\",\"label\":\"Dataset\",\"scale\":\"linear\",\"percent\":false,\"temporal\":false},\"y\":{\"field\":\"accuracy\",\"label\":\"Top-1 accuracy\",\"unit\":\"%\",\"scale\":\"linear\",\"percent\":false,\"temporal\":false},\"kind\":\"bar\",\"orientation\":\"vertical\",\"aggregation\":\"mean\",\"baseline_zero\":true,\"stacked\":false,\"value_labels\":false}"
X_AXIS_LABEL = "Dataset"
Y_AXIS_LABEL = "Top-1 accuracy (%)"
FIGURE_TITLE = "Accuracy across benchmarks"
ENCODING_SENTENCE = "Bar chart of Top-1 accuracy in % against Dataset. One series per model, being baseline, +augment, +distill, ours. Ours is drawn in the foreground."
AUTHOR_CONTEXT = None
CAPTION = None
X_LABEL_PLAIN = "dataset"
CLAIMS = []
DATA_HASH = "unknown"
ALT_TEXT = ""
DISCLOSURE = (
...
def series_style(name, index, total):
    ...
    if total <= SECOND_CHANNEL_THRESHOLD:
        ...
        channel = HATCHES[index % len(HATCHES)]
    else:
